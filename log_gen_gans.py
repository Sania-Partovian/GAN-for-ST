...
Original file is located at
    https://colab.research.google.com/drive/1tQBeHymAr9A7e5xBzqVjISQ65iQ-UnSt
"""

import pandas as pd

# Load the dataset
data_path = '/content/Hadoop_2k.log_structured.csv'
...
for col in ['Level', 'Process', 'Component', 'Content', 'EventTemplate', 'EventId']:
...
# Prepare to train
train_gan(generator, discriminator, gan, train_data_np, epochs=3000)
